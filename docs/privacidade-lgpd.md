...
Recall segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Recall (getrecall.ai)** | US | AI knowledge base API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [recall@mcp.ai](mailto:recall@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
